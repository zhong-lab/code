...
This software distribution package linux-gpib-4.2.0.tar.gz contains
this README and two tarballs:

1) kernel modules in linux-gpib-kernel-4.2.0.tar.gz

2) user space software in linux-gpib-use-4.2.0.tar.gz containing the
