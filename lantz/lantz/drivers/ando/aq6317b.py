...
class AQ6317B(MessageBasedDriver):
	...
	def tracing_conditions(self,key,values):
		""" Sends a program code to the AQ6317B and sets the tracing condition.
...
if __name__ == '__main__':
	...
	with AQ6317B('GPIB2::1::INSTR') as inst:
	...
	# read peak position for a while
		...
		while (t-start)<43200:
			with open('tunable_filter_tracking_1535.742.csv','a',newline='') as csvfile:
				writer=csv.writer(
				csvfile,
				delimiter=',',
				quotechar='|',
