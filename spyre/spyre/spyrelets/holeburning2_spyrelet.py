...
class HoleBurning(Spyrelet):
	...
	def pump(self, timestep):
		...
		chn1dc2.markerloc = 0
		chn1dc2.nrepeats = int((per-tri_time-params['wait time'].magnitude-params['pump width'].magnitude)/params['pump width'].magnitude)
		...
		chn2dc2.markerloc = 0
		chn2dc2.nrepeats = int((per-tri_time-params['wait time'].magnitude-params['pump width'].magnitude)/params['pump width'].magnitude)
		...
		seq = [chn1off1, chn1pulse,chn1off2, chn1dc, chn1trioff, chn1pulse2, chn1dc2]
		seq2 = [chn2off1,chn2pulse,chn2off2, chn2dc, chn2trioff, chn2pulse2, chn2dc2]
