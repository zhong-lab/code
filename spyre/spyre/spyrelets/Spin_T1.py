...
# Set the AWG 
		...
		pulsewidth0=params['pulse width0'].magnitude								
...
# Inversion pulse pulse

		InvPulseI = Arbseq_Class_MW('InvPulseI', timestep,Wavepi2pulse,InvAmp,pulsewidth0,freq,phase)
		InvPulseI.delays=predelay
		InvPulseI.postdelay=postdelay
		InvPulseI.sendTrigger()
		InvPulseI.create_envelope()

		InvPulseQ = Arbseq_Class_MW('InvPulseQ', timestep,Wavepi2pulse,InvAmp,pulsewidth0,freq,phase+deltaphiiq)
		InvPulseQ.delays=predelay
		InvPulseQ.postdelay=postdelay		
		InvPulseQ.create_envelope()



# Pi/2 pulse

		pi2PulseI = Arbseq_Class_MW('pi2PulseI', timestep,Wavepi2pulse,Pi2Amp,pulsewidth,freq,phase)
		pi2PulseI.delays=predelay
		pi2PulseI.postdelay=postdelay
		pi2PulseI.sendTrigger()
		pi2PulseI.create_envelope()

		pi2PulseQ = Arbseq_Class_MW('pi2PulseQ', timestep,Wavepi2pulse,Pi2Amp,pulsewidth,freq,phase+deltaphiiq)
...
# Pi Pulse
		...
		piPulseI = Arbseq_Class_MW('piPulseI', timestep,Wavepipulse,PiAmp,pulsewidth,freq,phase+deltaphase)
		...
		piPulseQ = Arbseq_Class_MW('piPulseQ', timestep,Wavepipulse,PiAmp,pulsewidth,freq,phase+deltaphase+deltaphiiq)
...
# Send all the Arbs
		...
		self.fungen.send_arb(InvPulseI, 1)
		...
		self.fungen.send_arb(InvPulseQ, 2)

# Make sequence

		seq = [delay0I,InvPulseI,delay0I,pi2PulseI, delay1, piPulseI]

		seq1 = [delay0Q,InvPulseQ,delay0Q, pi2PulseQ, delay1, piPulseQ]
...
# Set the delay generator for triggering the AWG and scope
		...
		self.delaygen.delay['C']=tau1
		self.delaygen.delay['D']=tau1+10e-9
