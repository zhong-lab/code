...
class MotorScan(Spyrelet):
    ...
    #    ('arbname', {'type': str, 'default': 'arbitrary_name'}),,
        ...
        ('Step', {'type': float, 'default': 0.5*1e-9, 'units':'m'}),
...
class LaserScan(Spyrelet):
    ...
    def scan(self):
        ...
        with Client(self.conn1) as dlc:
            ...
            for x in range(n-1):            
                ...
                dlc.set("laser1:ctl:scan:trigger:output-threshold",start_wavelength+0.1)
                while True:
                    st = dlc.get("io:digital-out2:value-act+0.1")
                    if st==False:
                        break 
                dlc.set("laser1:ctl:scan:trigger:output-threshold",stop_wavelength)  
                time.sleep(0.5)
    ...
    #    ('arbname', {'type': str, 'default': 'arbitrary_name'}),,
        ...
        w = ParamWidget(params)
        return w
>>>>>>> 61e1bbe1d727b03e4263484e0f5abbeb311ad930
