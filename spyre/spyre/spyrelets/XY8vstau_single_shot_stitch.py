...
# Start collecting data
		...
		np.savetxt('D:/MW data/20201111/XY8/Scan18/ch3/{}_{}.txt'.format(tau*1e6,npulses), np.c_[xdata,ydata])   
		np.savetxt('D:/MW data/20201111/XY8/Scan18/ch4/{}_{}.txt'.format(tau*1e6,npulses), np.c_[xdata1,ydata1])
	...
	def Record_XY8(self):
		...
		tauarray=[5e-6,6e-6,8e-6,10e-6,12e-6,14e-6,16e-6,18e-6,20e-6,21e-6,22e-6,23e-6,24e-6]    # for long T2 species
		#tauarray=[5e-6,6e-6,7e-6,8e-6,9e-6,10e-6,12e-6,14e-6,16e-6,18e-6]    # for short T2 species
