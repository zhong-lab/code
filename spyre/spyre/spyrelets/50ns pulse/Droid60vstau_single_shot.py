...
# Set the AWG 
		...
		Amp=params['PiVoltage'].magnitude
...
# Pimx Pulse
		...
		pimxPulseI = Arbseq_Class_MW('pimxPulseI', timestep,Wavepipulse,1,pulsewidth,freq,phase+deltaphase3)
		...
		pimxPulseQ = Arbseq_Class_MW('pimxPulseQ', timestep,Wavepipulse,1,pulsewidth,freq,phase+deltaphase3+deltaphiiq)
...
# Pimy Pulse
		...
		pimyPulseI = Arbseq_Class_MW('pimyPulseI', timestep,Wavepipulse,1,pulsewidth,freq,phase+deltaphase4)
		...
		pimyPulseQ = Arbseq_Class_MW('pimyPulseQ', timestep,Wavepipulse,1,pulsewidth,freq,phase+deltaphase4+deltaphiiq)
...
# COMP1 Pulse (pi/2x pi/2my)
		...
		COMP1PulseI = Arbseq_Class_MW('COMP1PulseI', timestep,'COMP1',1,pulsewidth,freq,phase)
		...
		COMP1PulseQ = Arbseq_Class_MW('COMP1PulseQ', timestep,'COMP1',1,pulsewidth,freq,phase+deltaphiiq)
...
# COMP2 Pulse (pi/2my pi/2x)
		...
		COMP2PulseI = Arbseq_Class_MW('COMP2PulseI', timestep,'COMP2',1,pulsewidth,freq,phase)
		...
		COMP2PulseQ = Arbseq_Class_MW('COMP2PulseQ', timestep,'COMP2',1,pulsewidth,freq,phase+deltaphiiq)
...
# COMP3 Pulse (pi/2x pi/2y)
		...
		COMP3PulseI = Arbseq_Class_MW('COMP3PulseI', timestep,'COMP3',1,pulsewidth,freq,phase)
		...
		COMP3PulseQ = Arbseq_Class_MW('COMP3PulseQ', timestep,'COMP3',1,pulsewidth,freq,phase+deltaphiiq)
...
# COMP4 Pulse (pi/2x pi/2y)
		...
		COMP4PulseI = Arbseq_Class_MW('COMP4PulseI', timestep,'COMP4',1,pulsewidth,freq,phase)
		...
		COMP4PulseQ = Arbseq_Class_MW('COMP4PulseQ', timestep,'COMP4',1,pulsewidth,freq,phase+deltaphiiq)
...
# Start collecting data
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200806/CPMG/Scan1/ch3/{}_{}.txt'.format(tau*1e6,npulses), np.c_[x,y])   
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200806/CPMG/Scan1/ch4/{}_{}.txt'.format(tau*1e6,npulses), np.c_[x,y])
	...
	def Record_XY8(self):
		...
		for tau in tauarray:
			...
			minscale=(2.0*60*tau*minreadpulses+tau)/10

			if(minscale>oscscale):
				timescale=maxscale
