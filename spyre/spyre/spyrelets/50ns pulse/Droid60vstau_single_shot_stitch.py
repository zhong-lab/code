...
# Start collecting data
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200806/DROID60/Scan1/ch3/{}_{}.txt'.format(tau*1e6,npulses), np.c_[x,y])   
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200806/DROID60/Scan1/ch4/{}_{}.txt'.format(tau*1e6,npulses), np.c_[x,y])
	...
	def Record_DROID60(self):
		...
		tauarray=[1e-6,2e-6,3e-6,4e-6,5e-6,6e-6,7e-6,8e-6,9e-6]
