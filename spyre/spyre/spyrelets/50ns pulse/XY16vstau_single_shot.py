...
# Start collecting data
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200806/XY16/Scan1/ch3/{}_{}.txt'.format(tau*1e6,npulses), np.c_[x,y])   
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200806/XY16/Scan1/ch4/{}_{}.txt'.format(tau*1e6,npulses), np.c_[x,y])
	...
	def Record_XY16(self):
		...
		tauarray=[2e-6,4e-6,6e-6,8e-6,10e-6,12e-6]
