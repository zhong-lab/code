...
class Record(Spyrelet):
	...
	def record(self,tau,measurementno):
# Set the AWG 
		self.dataset.clear()
...
# Start collecting data
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200805/SpinT2/Scan1/ch3/{}/{}.txt'.format(measurementno,tau*1e6), np.c_[x,y])   
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200805/SpinT2/Scan1/ch4/{}/{}.txt'.format(measurementno,tau*1e6), np.c_[x,y])
