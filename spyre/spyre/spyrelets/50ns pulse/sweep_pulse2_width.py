...
# Start collecting data
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200805/Optimization/sweepPulse2_width/ch3/{}.txt'.format(pulsewidth2*1e9), np.c_[x,y])   
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200805/Optimization/sweepPulse2_width/ch4/{}.txt'.format(pulsewidth2*1e9), np.c_[x,y])
	...
	def SweepPulse2(self):
		...
		# pulse2widths=[20e-9,30e-9,40e-9,50e-9,60e-9,70e-9,80e-9,100e-9]
		pulse2widths=[90e-9]
	...
	#    ('arbname', {'type': str, 'default': 'arbitrary_name'}),,
		...
		('pulse1 width', {'type': float, 'default': 50e-9, 'units':'s'}),
		('pulse2 width', {'type': float, 'default': 50e-9, 'units':'s'}),
