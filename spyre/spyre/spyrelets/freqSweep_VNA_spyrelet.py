...
class Sweep(Spyrelet):
    ...
    def sweep_frequency(self):
        ...
        while(int(self.source.sweep_run)!=0):
            ...
            with open('D:/MW data/test/20190814/JTWPA/scan_10/frequency sweep/{}.txt'.format(name),'a') as file:
                write_str='%f %f\n'%(frequency,power)
                file.write(write_str)
            self.vna.save_csv('D:/MW data/test/20190814/JTWPA/scan_10/frequency sweep/{}.csv'.format(delta_time))
    ...
    def sweep_power_frequency(self):
        ...
        for pw_point in range(int(pw_count)):
            ...
            while(int(self.source.sweep_run)!=0):
                ...
                with open('D:/MW data/test/20190814/JTWPA/scan_10/freq and pw/{}.txt'.format(name),'a') as file:
                    write_str='%f %f %f\n'%(frequency,power,S)
                    file.write(write_str)
                time.sleep(t)
        return
    ...
    def sweep_power(self):
        ...
        for p in range(0,pw_count):
            ...
            with open('D:/MW data/test/20190814/JTWPA/scan_10/power sweep/{}.txt'.format(name),'a') as file:
                write_str='%f %f\n'%(frequency,amplitude)
                file.write(write_str)
            self.vna.save_csv('D:/MW data/test/20190814/JTWPA/scan_10/power sweep/{}.csv'.format(delta_time))
            #self.vna.save_csv_second('D:/MW data/test/20190813/JTWPA/scan_1/phase/{}.csv'.format(delta_time))
            time.sleep(t)
        return
