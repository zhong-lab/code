...
# Start collecting data
		...
		np.savetxt('D:/MW data/20201106/customized48/Scan1/ch3/{}_{}.{}.txt'.format(tau*1e6,npulses,count), np.c_[xdata,ydata])   
		np.savetxt('D:/MW data/20201106/customized48/Scan1/ch4/{}_{}.{}.txt'.format(tau*1e6,npulses,count), np.c_[xdata1,ydata1])
