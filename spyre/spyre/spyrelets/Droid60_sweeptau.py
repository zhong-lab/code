...
# Set the Source frequency offset from the cavity by IF frequency 
		...
		self.osc.delay_time(48*2*tau*npulses-400e-9)  # This makes sure that echo is at center of screen
...
# Start collecting data
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200811/DROID60/Scan3/ch3/{}.txt'.format(48*2*tau*npulses*1e6), np.c_[x,y])   
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200811/DROID60/Scan3/ch4/{}.txt'.format(48*2*tau*npulses*1e6), np.c_[x,y])
	...
	def Record_DROID60(self):
		...
		tauarray=[1e-6,1.5e-6,2e-6,2.5e-6,3e-6,3.5e-6,4e-6,4.5e-6,5e-6,5.5e-6,6e-6,6.5e-6,7e-6,7.5e-6,8e-6,8.5e-6,9e-6,10e-6,11e-6,12e-6,13e-6,14e-6,15e-6,16e-6,17e-6,18e-6,19e-6,20e-6,21e-6,22e-6,23e-6,24e-6,25e-6,26e-6,27e-6,28e-6,29e-6,30e-6]
