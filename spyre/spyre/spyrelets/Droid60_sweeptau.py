...
# Start collecting data
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20201026/DROID60/Scan1/ch3/{}.txt'.format(48*2*tau*npulses*1e6), np.c_[x,y])   
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20201026/DROID60/Scan1/ch4/{}.txt'.format(48*2*tau*npulses*1e6), np.c_[x,y])
	...
	def Record_DROID60(self):
		...
		tauarray=[5e-6,5.5e-6,6e-6,6.5e-6,8e-6,9e-6,11e-6,12e-6]
