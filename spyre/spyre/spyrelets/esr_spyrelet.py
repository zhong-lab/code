...
class Record(Spyrelet):
    ...
    def Record_ESR(self,FMfreq,dev,center,scantime,time_constant,rf_power):
        ...
        file = open('D:/MW data/20200930/ESR/esr/1/scan.txt','w') 
    ...
    def Record_data(self):
        ...
        dev=650e3
        freq=65e3    
        center=5.697596800e9

        scantime=1*60*60 #Scantime in seconds
        B0=0
        B1=240
        self.Record_ESR(freq,dev,center,scantime,time_constant,rf_power)

        file = open('D:/MW data/20200930/ESR/esr/1/simulationdata.txt','w') 
