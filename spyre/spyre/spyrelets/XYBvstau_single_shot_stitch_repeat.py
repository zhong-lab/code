...
# Set the AWG 
		...
		Amp_factor_pi2=params['Pi2voltage'].magnitude*0.5
		Amp_factor_pi=params['Pivoltage'].magnitude*0.5
...
#5
			...
			seq.append(COMP8PulseI)   #Pi2y, Pi2mx
			seq.append(delay2)	
...
#5
			...
			seq1.append(COMP8PulseQ)   #Pi2y, Pi2mx
			seq1.append(delay2)	
...
# Start collecting data
		...
		np.savetxt('D:/MW data/20201106/XYB/Scan1/ch3/{}_{}.{}.txt'.format(tau*1e6,npulses,count), np.c_[xdata,ydata])   
		np.savetxt('D:/MW data/20201106/XYB/Scan1/ch4/{}_{}.{}.txt'.format(tau*1e6,npulses,count), np.c_[xdata1,ydata1])
	...
	@Record_XYB.initializer
	def initialize(self):
		return

	@Record_XYB.finalizer
	def finalize(self):
		return
