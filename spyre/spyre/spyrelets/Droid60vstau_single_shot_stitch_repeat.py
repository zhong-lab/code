...
# Start collecting data
		...
		np.savetxt('D:/MW data/20201111/DROID60/Scan1/ch3/{}_{}.{}.txt'.format(tau*1e6,npulses,count), np.c_[xdata,ydata])   
		np.savetxt('D:/MW data/20201111/DROID60/Scan1/ch4/{}_{}.{}.txt'.format(tau*1e6,npulses,count), np.c_[xdata1,ydata1])
	...
	def Record_DROID60(self):
		...
		time.sleep(7200)     # wait for 2 hour for temperature to stabilize
