...
# Start collecting data
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200809/Optimization/sweepPulse2/ch3/{}.txt'.format(PiAmp), np.c_[x,y])   
		...
		x = x-x.min()
		y = np.array(y)
		np.savetxt('D:/MW data/20200809/Optimization/sweepPulse2/ch4/{}.txt'.format(PiAmp), np.c_[x,y])
