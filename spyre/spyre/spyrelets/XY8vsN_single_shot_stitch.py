...
class Record(Spyrelet):
	...
	def record(self,tau,ndelay,npulses):
# Set the AWG 
		self.dataset.clear()
...
# Start collecting data
		...
		np.savetxt('D:/MW data/20200811/XY8/Scan2/ch3/{}_{}.txt'.format(tau*1e6,npulses), np.c_[xdata,ydata])   
		np.savetxt('D:/MW data/20200811/XY8/Scan2/ch4/{}_{}.txt'.format(tau*1e6,npulses), np.c_[xdata1,ydata1])
