...
class Record(Spyrelet):
    ...
    def slope(self,value):
        ...
        frequency_start = 5085.0 * MHz
        frequency_stop = 5095.0 * MHz
        frequency_step = 0.01 * MHz
        ...
        file = open('D:/MW data/20191106/slope/6/{}.txt'.format(value),'a') 
        write_str='%f %f %f %f %f\n'%(0,0,0,0,0)
        ...
        while(self.source.frequency<frequency_stop):
            ...
            # a = np.loadtxt('D:/MW data/20191030/slope/3/{}.txt'.format(value))
            # self.X_s = a[1:,0]
            # self.Y_s = a[1:,1]
            # self.R_s = a[1:,2]
            # self.theta_s = a[1:,3]
